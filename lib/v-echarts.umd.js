(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("resize-observer-polyfill"), require("echarts/lib/echarts"));
	else if(typeof define === 'function' && define.amd)
		define(["resize-observer-polyfill", "echarts/lib/echarts"], factory);
	else if(typeof exports === 'object')
		exports["v-echarts"] = factory(require("resize-observer-polyfill"), require("echarts/lib/echarts"));
	else
		root["v-echarts"] = factory(root["resize-observer-polyfill"], root["echarts/lib/echarts"]);
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE_a1cc__, __WEBPACK_EXTERNAL_MODULE_aacf__) {
...
// CONCATENATED MODULE: ./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"61bf804a-vue-loader-template"}!./node_modules/_vue-loader@15.9.3@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js??ref--0-0!./node_modules/_vue-loader@15.9.3@vue-loader/lib??vue-loader-options!./packages/echarts.vue?vue&type=template&id=0a6ca1b7&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"v-echarts"})}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/echarts.vue?vue&type=template&id=0a6ca1b7&
...
// CONCATENATED MODULE: ./node_modules/_@babel_runtime@7.11.0@@babel/runtime/helpers/esm/defineProperty.js
...
// CONCATENATED MODULE: ./node_modules/_@babel_runtime@7.11.0@@babel/runtime/helpers/esm/objectSpread2.js
...
var echarts_ = __webpack_require__("aacf");
...
// CONCATENATED MODULE: ./node_modules/_@babel_runtime@7.11.0@@babel/runtime/helpers/esm/arrayLikeToArray.js
...
// CONCATENATED MODULE: ./node_modules/_@babel_runtime@7.11.0@@babel/runtime/helpers/esm/unsupportedIterableToArray.js
...
// CONCATENATED MODULE: ./node_modules/_@babel_runtime@7.11.0@@babel/runtime/helpers/esm/createForOfIteratorHelper.js
...
var resize_event_addResizeListener = function addResizeListener(element, fn) {
  ...
  if (!element.__resizeListeners__) {
    ...
    element.__ro__ = new external_resize_observer_polyfill_default.a(resize_event_resizeHandler);
...
// CONCATENATED MODULE: ./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js??ref--12-0!./node_modules/_thread-loader@2.1.3@thread-loader/dist/cjs.js!./node_modules/_babel-loader@8.1.0@babel-loader/lib!./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js??ref--0-0!./node_modules/_vue-loader@15.9.3@vue-loader/lib??vue-loader-options!./packages/echarts.vue?vue&type=script&lang=js&
...
var METHODS = {};
["setOption", "getWidth", "getHeight", "getOption", "dispatchAction", "convertToPixel", "convertFromPixel", "containPixel", "showLoading", "hideLoading", "getDataURL", "getConnectedDataURL", "appendData", "clear", "isDisposed"].forEach(function (m) {
  METHODS[m] = function () {
    if (this.chart) {
      var _this$chart;

      return (_this$chart = this.chart)[m].apply(_this$chart, arguments);
    } else {
      throw new Error("缺少图表实例");
    }
  };
});
var EVENTS = ["legendselectchanged", "legendselected", "legendunselected", "datazoom", "datarangeselected", "timelinechanged", "timelineplaychanged", "restore", "dataviewchanged", "magictypechanged", "geoselectchanged", "geoselected", "geounselected", "pieselectchanged", "pieselected", "pieunselected", "mapselectchanged", "mapselected", "mapunselected", "axisareaselected", "focusnodeadjacency", "unfocusnodeadjacency", "brush", "brushselected", "click", "dblclick", "mouseover", "mouseout", "mousedown", "mouseup", "globalout"];
/* harmony default export */ var echartsvue_type_script_lang_js_ = ({
    ...
    resizeable: {
      ...
      handler: function handler(v) {
        ...
        this.$nextTick(function () {
          v ? resize_event_addResizeListener(_this.$el, _this.resize) : removeResizeListener(_this.$el, _this.resize);
        });
      }
    },
  ...
  methods: _objectSpread2(_objectSpread2({}, METHODS), {}, {
    ...
    renderChart: function renderChart() {
      ...
      this.chart = echarts_default.a.init(this.$el, this.theme, this.init);
    ...
    bindEvent: function bindEvent() {
      ...
      this.binds.forEach(function (en) {
        _this2.chart.off(en);
      });
      this.binds = [];
      Object.keys(this.$listeners).forEach(function (en) {
        ...
        _this2.chart.on(en, function (params) {
          _this2.$emit(en, params);
        });

        _this2.binds.push(en);
      });
    }
  })
});
// CONCATENATED MODULE: ./packages/echarts.vue?vue&type=script&lang=js&
 /* harmony default export */ var packages_echartsvue_type_script_lang_js_ = (echartsvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./packages/echarts.vue
...
var component = normalizeComponent(
  packages_echartsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var packages_0 = (echarts);
...
module.exports = __WEBPACK_EXTERNAL_MODULE_a1cc__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE_aacf__;
